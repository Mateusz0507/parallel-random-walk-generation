...
namespace algorithms
{
	namespace genetic
	{
		class genetic_improved_method : public abstract_method
		{
		public:
			genetic_improved_method();
		...
		protected:
			...
			int* dev_valid_points;
			int* dev_random_walk_idx;
			...
			thrust::device_ptr<int> dev_valid_points_ptr;
			thrust::device_ptr<int> dev_random_walk_idx_ptr;
